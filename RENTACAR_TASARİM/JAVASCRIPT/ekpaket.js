...
{
  fiyatdegis=127;
     document.getElementById("fiyat").innerHTML="Bu Paketin Tutarı : 127 TL";
   document.getElementById("guvence").innerHTML="Süper Mini Güvence Paketi";
  document.getElementById("modaliciyazi").innerHTML = "Rapor düzenlenmesi veya tutanak tutulması mümkün olmayan, tek taraflı hasar durumları için müşteriye 2.500 TL'ye kadar beyanla onarım hakkı sunan hasar güvencesidir. Cam - far - ayna güvencesini de kapsamaktadır.";
   modal.showModal();
...
{
  fiyatdegis=150;
   document.getElementById("fiyat").innerHTML="Bu Paketin Tutarı : 150 TL";
  document.getElementById("guvence").innerHTML="Orta Güvence Paketi";
  document.getElementById("modaliciyazi").innerHTML = "Süper Mini Güvence Paketine ek olarak Trafik sigortası kapsamında 3. şahıslara ilişkin hasar limitini bu güvence ile 1 milyon TL'ye kadar artırabilirisiniz.";
   modal.showModal();
   document.getElementById("modal").style.transform = "scale(1.1)";
...
{
  fiyatdegis=191;
   document.getElementById("fiyat").innerHTML="Bu Paketin Tutarı : 191 TL";
  document.getElementById("guvence").innerHTML="Tam Güvence Paketi";
  document.getElementById("modaliciyazi").innerHTML = "Süper Mini Güvence Paketi ve Orta Güvence Paketine Ek olarak Araç içerisindeki koltuk sayısına bağlı olarak, sürücü ve araç içerisindeki kişileri kapsayan güvencedir.";
