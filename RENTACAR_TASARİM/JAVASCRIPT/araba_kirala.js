...
function verilerial()
{
  ...
  sessionStorage.setItem("konum",konum);
  var alis=document.getElementById("alis").value;
   var teslim=document.getElementById("teslim").value;
   var x=teslim[8]+teslim[9];
   var y=alis[8]+alis[9];
   var fiyat=x-y;
   
   var ab=sessionStorage.getItem("aracfiyat");
   fiyat=fiyat*ab;
   sessionStorage.setItem("aracfiyat",fiyat);
   window.location.href="ekpaket.html";
