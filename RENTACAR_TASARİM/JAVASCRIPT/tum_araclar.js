...
function verigonder(id)
{
  
 var aracadi=document.getElementById(id).innerText;
  sessionStorage.setItem("aracadi",aracadi);
  var cookieValue = document.getElementById(id).getAttribute('value');
  sessionStorage.setItem("aracfiyat",cookieValue);
}
function hakkimizda()
{
